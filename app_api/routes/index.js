...
var ctrlVenues = require("../controllers/VenueController"); // Ensure this path is correct
...
router
  ...
  .get(ctrlVenues.getVenues)
  .put(ctrlVenues.updateVenues)
  .delete(ctrlVenues.deleteVenues);
